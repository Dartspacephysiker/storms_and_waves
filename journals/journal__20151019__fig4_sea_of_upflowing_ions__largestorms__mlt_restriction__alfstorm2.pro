...
PRO JOURNAL__20151019__FIG4_SEA_OF_UPFLOWING_IONS__LARGESTORMS__MLT_RESTRICTION__ALFSTORM2
  ...
  SUPERPOSE_STORMS_ALFVENDBQUANTITIES,RANDOMTIMES=40,/NOPLOTS,/NOMAXPLOTS,OUT_BKGRND_MAXIND=bkgrnd_maxInd,OUT_TBINS=tBins,/USE_DARTDB_START_ENDDATE, $
                           MAXIND=maxInd,NEVBINSIZE=nEvBinsize,TBEFORESTORM=60.0D,TAFTERSTORM=60.0D,AVG_TYPE_MAXIND=1,/LOG_DBQUANTITY, $
                           MINMLT=minM,MAXMLT=maxM

  ;ION_FLUX_UP
  SUPERPOSE_STORMS_ALFVENDBQUANTITIES,/NOGEOMAGPLOTS,STORMTYPE=1,STORMINDS=q1_st,SSC_TIMES_UTC=q1_utc,REMOVE_DUPES=rmDupes, $
