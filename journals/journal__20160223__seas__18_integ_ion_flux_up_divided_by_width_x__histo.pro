...
PRO JOURNAL__20160223__SEAS__18_INTEG_ION_FLUX_UP_DIVIDED_BY_WIDTH_X__HISTO
  ...
  maxInd                = 18
  divide_by_width_x     = 1
  yTitle                = "Spatially averaged upward ion flux" + title__alfDB_ind_18
  ...
  probOccPref           = pref + 'spatialAvg_16_ion_flux_up--with_NOAA--justhisto'
  ptPref                = ''
