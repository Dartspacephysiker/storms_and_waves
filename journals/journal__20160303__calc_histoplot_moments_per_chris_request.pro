PRO JOURNAL__20160303__CALC_HISTOPLOT_MOMENTS_PER_CHRIS_REQUEST


  date         = '20160303'

  outText      = date + '--10_EFLUX_LOSSCONE_INTEG__18_INTEG_ION_FLUX_UP__49_PFLUXEST--moments.txt'
  OPENW,lun,outText,/GET_LUN

  dayFiles     = [date+'--stormphase_histos--overlaid_phases--10_EFLUX_LOSSCONE_INTEG.sav', $
                  date+'--stormphase_histos--overlaid_phases--18_INTEG_ION_FLUX_UP.sav', $
                  date+'--stormphase_histos--overlaid_phases--49_PFLUXEST.sav']

  nightFiles   = [date+'--stormphase_histos--overlaid_phases--10_EFLUX_LOSSCONE_INTEG--6.0-18.0--18.0-6.0_MLT.sav', $
                  date+'--stormphase_histos--overlaid_phases--18_INTEG_ION_FLUX_UP--6.0-18.0--18.0-6.0_MLT.sav', $
                  date+'--stormphase_histos--overlaid_phases--49_PFLUXEST--6.0-18.0--18.0-6.0_MLT.sav']
