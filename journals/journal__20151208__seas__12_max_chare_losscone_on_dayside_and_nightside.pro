...
PRO JOURNAL__20151208__SEAS__12_MAX_CHARE_LOSSCONE_ON_DAYSIDE_AND_NIGHTSIDE
  ...
  ;;strings 'n' things
  probOccPref       = 'journal_20151208--SEA_largestorms--12-MAX_CHARE_LOSSCONE--with_NOAA'
  ptPref            = ''
  plotSuff          = '--all_MLT_day_night.png'

  maxInd            = 12
  yTitle            = 'e- Losscone Characteristic Energy (eV)'
