...
PRO JOURNAL__20151208__SEAS__18_INTEG_ION_FLUX_UP_ON_DAYSIDE_AND_NIGHTSIDE__TRY_WITHOUT_NOAA_SSCS
  ...
  ;;strings 'n' things
  probOccPref       = 'journal_20151208--SEA_largestorms--18-INTEG_ION_FLUX_UP--without_NOAA'
  ptPref            = ''
