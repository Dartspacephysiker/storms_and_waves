...
PRO JOURNAL__20151223__SEAS__16_ION_FLUX_UP_DAYSIDE_AND_NIGHTSIDE__RUNNING_MEDIAN__DAWNDUSK_ASYM
  ...
  ;;strings 'n' things
  probOccPref       = 'journal_20151223--SEA_largestorms--16-ION_FLUX_UP--with_NOAA--running_median--dawndusk_asym'
  ptPref            = ''
  plotSuff          = '--all_MLT_day_night.png'

  maxInd            = 16
  yTitle            = '16-Max upward ion flux ($#/cm^2-s$)'
