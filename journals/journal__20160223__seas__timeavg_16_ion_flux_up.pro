...
PRO JOURNAL__20160223__SEAS__TIMEAVG_16_ION_FLUX_UP
  ...
  maxInd                = 16
  yTitle                = "Time-averaged " + title__alfDB_ind_16
  ...
  probOccPref           = pref + 'timeAvg_16_ion_flux_up--with_NOAA--justhisto'
  ptPref                = ''
