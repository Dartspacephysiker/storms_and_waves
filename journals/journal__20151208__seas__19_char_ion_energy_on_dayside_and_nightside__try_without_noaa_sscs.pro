...
PRO JOURNAL__20151208__SEAS__19_CHAR_ION_ENERGY_ON_DAYSIDE_AND_NIGHTSIDE__TRY_WITHOUT_NOAA_SSCS
  ...
  ;;strings 'n' things
  probOccPref       = 'journal_20151208--SEA_largestorms--19-CHAR_ION_ENERGY--without_NOAA'
  ptPref            = ''
  plotSuff          = '--all_MLT_day_night.png'

  maxInd            = 19
  yTitle            = 'Ion Characteristic Energy (eV)'
