;2016/06/25 Making a new version to deal with the harsh reality that everything past Nov 1999 is bogus
;
...
PRO JOURNAL__20160625__GET_FOUR_QUADRANT_INDS__BEF_NOV_1999

  DBDIR         = '/SPENCEdata/Research/database/storm_data/'
  DB_BRETT      = 'large_and_small_storms--1985-2011--Anderson.sav'
  DB_NOAA       = 'SSC_dbs--storm2_mods.txt__STORM2_MODS.SSC--idl.sav'

  inds_outDir   = '/SPENCEdata/Research/database/storm_data/'
  INDS_OUTFILE  = 'large_and_small_storms--Oct1996-Nov1999--indices_for_four_quadrants--Anderson.sav'
  INDS_OUTFILE  = 'large_and_small_storms--Oct1996-Nov1999--indices_for_four_quadrants--Anderson.sav'

  ;; some helper vars
  maxDiff       = 24./24.; Brett's stuff can lead sudden commencement by 24 hours, according to the
                   ; submitted draft
  s2day         = 1./86400.
  ...
  ;;We're only worried about where we have good FAST data
  ;;That seems to stop after orbit 12670 (just look at the E-field data)
  t1str= '1996-10-06/16:26:02.417'
  t2str= '1999-11-03/03:09:34.200'
  ...
  IF do_loc_st THEN BEGIN 
     ...
     qi_NOAA = {qi_SSC, $
                NAME:'qi_NOAA', $
                GENERATING_FILE:'journal__20160625__get_four_quadrant_inds__bef_nov_1999.pro', $
