...
PRO JOURNAL__20151026__GEN_PNG_OF_ALL_LARGESTORMS_AND_EVENTS
  ...
  FOR i = 24, N_ELEMENTS(q1_st)-1,nPlotsPerWindow DO BEGIN
  ;;SSC-centered here
     iFirst         = i
     ...
     STACKPLOTS_STORMS_ALFVENDBQUANTITIES_OVERLAID,q1_utc[iFirst:iLast],STORMTYPE=1,EPOCHINDS=q1_st[iFirst:iLast], $
        /USE_DARTDB_START_ENDDATE,TBEFOREEPOCH=15.,TAFTEREPOCH=60., $
        MAXIND=maxInd, $
        ...
        /DO_SCATTERPLOTS,EPOCHPLOT_COLORNAMES=colors, $
        SCATTEROUTPREFIX=scOutFilePref,/SHOW_DATA_AVAILABILITY,/JUST_ONE_LABEL,/OVERPLOT_ALFVENDBQUANTITY
  ENDFOR
