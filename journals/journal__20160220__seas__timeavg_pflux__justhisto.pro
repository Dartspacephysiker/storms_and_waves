...
;2016/02/20 Got some serious issues here. Don't know what to say about them, but I think it has to do with the conflict now
;presented by all of the COMMON block variables that get saved for fastLoc and maximus.

PRO JOURNAL__20160220__SEAS__TIMEAVG_PFLUX__JUSTHISTO
  ...
  probOccPref       = pref + 'timeAvg_pFlux--with_NOAA--justhisto'
  ptPref            = ''
