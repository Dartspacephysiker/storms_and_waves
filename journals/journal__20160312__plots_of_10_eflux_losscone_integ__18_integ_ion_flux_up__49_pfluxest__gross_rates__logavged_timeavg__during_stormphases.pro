...
PRO JOURNAL__20160312__PLOTS_OF_10_EFLUX_LOSSCONE_INTEG__18_INTEG_ION_FLUX_UP__49_PFLUXEST__GROSS_RATES__LOGAVGED_TIMEAVG__DURING_STORMPHASES
  dstCutoff = -20
  ...
  eNumFlPlotRange                = [10^(2.0),10^(4.5)]

  ;;;;;;;;;;;;;;;;;;;;;;
  ;;18-INTEG_ION_FLUX_UP
  maxInd                         = 18
  ifpt                           = 'INTEG_UP'
  iPlotRange                     = [10.^(16.0),10.^(19.5)]

  ;;;;;;;;;;;;;;;;;;;;;;
  ;;49--PFLUXEST
  pPlotRange                     = [10.^(2.5),10.^(5.0)] ;for pFlux divided by width_x and multiplied by area
  logPFPlot                      = 1
