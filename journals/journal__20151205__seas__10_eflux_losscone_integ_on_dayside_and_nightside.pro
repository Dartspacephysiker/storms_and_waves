PRO JOURNAL__20151205__SEAS__10_EFLUX_LOSSCONE_INTEG_ON_DAYSIDE_AND_NIGHTSIDE
  ...
  ;;strings 'n' things
  probOccPref = 'journal_20151205--SEA--10-EFLUX_LOSSCONE_INTEG--with_NOAA--'
  ptPref            = ''
  plotSuff          = '.png'

  maxInd            = 10
  ;; yTitle            = "Integrated ion flux (N $cm^{-3}$)"
  yTitle            = 'Integ. L.C. e- Flux (ergs/$cm^{2}$-s), at ionos.'
