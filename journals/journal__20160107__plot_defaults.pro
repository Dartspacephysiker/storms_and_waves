  ...
  plotSuff          = '--with_NOAA--smoothed_running_logAvg--day_night__north_hemi--60-hrmin.png'
  ;; plotSuff          = '--with_NOAA--smoothed_running_logAvg--day_night__north_hemi--1-hrmin.png'
