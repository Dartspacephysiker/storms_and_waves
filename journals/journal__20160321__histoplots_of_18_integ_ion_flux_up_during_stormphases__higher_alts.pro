PRO JOURNAL__20160321__HISTOPLOTS_OF_18_INTEG_ION_FLUX_UP_DURING_STORMPHASES__HIGHER_ALTS
  ...
  ;; restrict_altRange = [2000,4175] & dayYRange = [0,0.12] & nightYRange = [0,0.12]
