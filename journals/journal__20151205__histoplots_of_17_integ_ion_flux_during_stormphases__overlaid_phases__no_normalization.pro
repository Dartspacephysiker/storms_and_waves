...
PRO JOURNAL__20151205__HISTOPLOTS_OF_17_INTEG_ION_FLUX_DURING_STORMPHASES__OVERLAID_PHASES__NO_NORMALIZATION
  ...
  HISTOPLOT_ALFVENDBQUANTITIES_DURING_STORMPHASES__OVERLAY_PHASES, $
     ...
     /ONLY_POS, $
     /SAVEPLOT, $
     PLOTSUFFIX='dayside--nightside--only_pos--no_normalization', $
     HISTOPLOT_PARAM_STRUCT=pHP, $
     CURRENT_WINDOW=window, $
     OUTPLOTARR=outplotArr
