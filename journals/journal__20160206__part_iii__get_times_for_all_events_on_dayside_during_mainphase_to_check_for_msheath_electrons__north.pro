...
PRO JOURNAL__20160206__PART_III__GET_TIMES_FOR__SEVERAL_EVENTS_ON_DAYSIDE_DURING_MAINPHASE_TO_CHECK_FOR_MSHEATH_ELECTRONS__NORTH

  inds_filename                 = 'journal__20160206__inds_for_all_events_on_dayside_during_mainphase_to_check_for_msheath_electrons__north.sav'
