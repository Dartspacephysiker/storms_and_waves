PRO JOURNAL__20160105__SEAS__08_ELEC_ENERGY_FLUX_ON_DAYSIDE_AND_NIGHTSIDE__SMOOTHED_RUNNING_AVG__DROP_ALL_MLT
  ...
  probOccPref       = 'journal_20160105--SEA_largestorms--' + maxQuant + '--with_NOAA--smoothed_running_logAvg'
  ptPref            = ''
